...
export default function LandingPage() {
  ...
  <div id="home" data-section="home">
      ...
      mediaItems={[
        ...
        {
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3DiHVpvKtHQYrAXbIa9LZ6hs5Mg/uploaded-1778758114220-otdsk11w.png",
          imageAlt: "Royal Pop Orange Strap",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/plain-dark-gray-wall-product-background_53876-167264.jpg",
          imageAlt: "Royal Pop Concept",
        },
      ]}
  ...
  <div id="about" data-section="about">
      ...
      heading={[
        {
          type: "text",
          content: "Royal Pop was made to be styled. We are making it wearable.",
        },
      ]}
    />
  </div>
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",
          title: "Is RoyalPop Select an official Swatch or Audemars Piguet product?",
          content: "No. RoyalPop Select is an independent accessory brand and is not affiliated with, endorsed by, or sponsored by Swatch, Audemars Piguet, or any related brands.",
        },
        {
          id: "q2",
          title: "What is RoyalPop Select creating?",
          content: "We are developing premium compatible wrist straps, holders, and styling accessories designed for Royal Pop owners.",
        },
        {
          id: "q3",
          title: "When will the first drop launch?",
          content: "The first drop is currently in development. Join the waitlist to receive early access and launch updates.",
        },
        {
          id: "q4",
          title: "Will the straps match different Royal Pop colors?",
          content: "Yes. The concept is to create color-matched compatible straps designed around each Royal Pop color.",
        },
        {
          id: "q5",
          title: "Is the product shown final?",
          content: "Some visuals may be concept visuals while the product is in development. Final product details may vary.",
        },
      ]}
